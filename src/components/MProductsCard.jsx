		...
		<>
			<div className='flex flex-col relative p-3 rounded-lg border shadow-sm hover:shadow-md'>
				...
				<div className='flex items-center justify-evenly'>
					...
					<span className='flex items-center justify-center bg-green-500 rounded-full text-white px-1 py-1 text-sm'>&#2547; {product?.price}</span>
					<span className='flex'>
						<AiFillEdit
							onClick={() =>
					...
					<span className='flex my-2'>
						<MdDeleteForever className='cursor-pointer flex items-center justify-center w-[30px] h-[30px] bg-red-500 rounded-full text-white px-2 py-2 text-xl' />
					</span>
				</div>
			</div>
		</>
